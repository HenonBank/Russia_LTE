...
_RU_NETWORKS_RAW = [
    ...
    "87.236.16.0/24",
    # Yandex
    "51.250.48.0/24", "84.201.188.0/23", "84.201.184.0/22", "84.201.128.0/18", 
    "158.160.0.0/16",
    # Selectel
    "5.178.85.0/24", "5.188.112.0/21", "5.188.112.0/24", "5.188.113.0/24", 
    "5.188.114.0/24", "5.188.115.0/24", "31.129.42.0/24", "31.131.251.0/24", 
    "31.184.215.0/24", "37.9.4.0/24", "45.90.244.0/24", "46.148.227.0/24", 
    "46.182.24.0/21", "46.182.24.0/24", "80.93.181.0/24", "80.93.187.0/24", 
    "81.163.22.0/24", "81.163.23.0/24", "82.202.220.0/24", "82.202.252.0/24", 
    "87.228.101.0/24", "87.242.108.0/24", "92.53.74.0/24", "94.26.224.0/24", 
    "109.71.12.0/24", "109.71.13.0/24", "109.234.155.0/24", "146.185.192.0/24", 
    "164.138.102.0/24", "185.91.52.0/22", "185.91.52.0/24", "185.91.53.0/24", 
    "185.91.54.0/24", "185.91.55.0/24", "185.189.195.0/24", "188.68.218.0/24", 
    "188.68.219.0/24", "188.68.221.0/24", "188.93.19.0/24", "212.41.170.0/24", 
    "212.41.26.0/24",
    # TimeWeb
